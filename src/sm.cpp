...
/*------------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------------
  Description :
  Implementation of the ESP32 state machine module
  ------------------------------------------------------------------------------
*/
#include "WiFi.h"
...
void SM_init(void)
{
  ...
  StateBleConnect =    _machine.addState(&stateBleConnect);
  StateWifiScan =    _machine.addState(&stateWifiScan);
  StateWifiConnect = _machine.addState(&stateWifiConnect);
  StateNetworkConnect =    _machine.addState(&stateNetworkConnect);
}
